        ...
        body: Column(
            children: [
              ...
              OutlinedButton(
                ...
                child: Text(isFilterApplied ? 'Clear' : 'Live Astro',
                  style: TextStyle(
                      color: isFilterApplied ? Colors.red : AppColors
                          .darkTeal2),),
              ...
              Expanded(child: Obx(() {
                return ApiAccess.liveAstrologers.isEmpty
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (isFilterApplied && !(astrologer['is_online'] == 1 &&
                                        ...
                                        Positioned(
                                          ...
                                          child: CircleAvatar(
                                              ...
                                              backgroundColor: () {
                                                ...
                                                final isOnline = astrologer['is_online'] ==
                                                    1;
                                                final isAvailableChat = astrologer['available_chat'] ==
                                                    'yes';
                                                final isBusy = astrologer['is_busy'] ==
                                                    'yes';
                                  ...
                                  Flexible(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        DesignText(
                                          '${ApiAccess
                                              .liveAstrologers[index]?['experience'] ??
                                              0} Years',
                                          fontSize: 12,
                                          fontWeight: 500,
                                          color: AppColors.lightGrey1,
                                        ...
                                        DesignText(
                                          'Rs.${ApiAccess
                                              .liveAstrologers[index]?['chat_price'] ??
                                              0}/Min',
                                          fontSize: 12,
                                          fontWeight: 500,
                                          color: AppColors.red,
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      padding: EdgeInsets
                                                          ...
                                                          horizontal: 12),
                                                      child: DesignText(
                                                        'You need to pay Rs.${ApiAccess
                                                            .liveAstrologers[index]['chat_price'] ??
                                                            0}/Min to access this',
                                                        fontSize: 16,
                                                        fontWeight: 400,
                                                        textAlign:
                                                        TextAlign.center,
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: DesignButtons(
                                                        onPressed: () async {
                                                          ...
                                                          var astrologerData = ApiAccess
                                                              .liveAstrologers[index];
                                                          var astrologer_id = astrologerData is Map
                                                              ? astrologerData['astrologer_id'] ??
                                                              0
                                                              : 0;
                                                          var name = astrologerData is Map
                                                              ? astrologerData['name'] ??
                                                              ''
                                                              : '';
