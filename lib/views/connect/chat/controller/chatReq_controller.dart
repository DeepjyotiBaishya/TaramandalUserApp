...
class ChatController extends GetxController {
  ...
  Future<bool?> reqChatApi({required Map<String, dynamic> data, Function? success, Function? error, String? page}) async {
    try {
      dio.Response response = await dio.Dio().post(
        ApiConfig.userlaunchchat,
        data: data,
        options: dio.Options(headers: {'Authorization': 'Bearer ' + PrefrenceDataController.to.token.value, 'Accept': 'application/json'}),
      );
  ...
  Future<bool?> chatStatusApi({required Map<String, dynamic> data, Function? success, Function? error}) async {
    try {
