        ...
        body:  Obx(() {
          return ChatController.to.showReviewRatingsRes.isEmpty
            ...
            child: Column(
              ...
              : ListView.builder(
            itemCount: (ChatController.to.showReviewRatingsRes['data'] ?? []).length,
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                    image: NetworkImage(
                                                      /*livedata.photo != null*/
                                                      false
                                                          ? 'https://thetaramandal.com/public/astrologer/1678733276.jpg}'
                                        ...
                                        Flexible(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              RatingBar.builder(
                                                initialRating: double.parse('${ChatController.to.showReviewRatingsRes['data']?[index]?['star_rating'] ?? '0'}'),
